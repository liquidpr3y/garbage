...
from necropsy.enums import Arch, FileType, JobKind
from necropsy.scoring import rules

# Kinds not yet implemented, and the phase that lands each.
PLANNED: dict[str, str] = {
    JobKind.STATIC_TRIAGE.value: "Phase 2 (rizin pre-triage + PE parsing)",
    JobKind.YARA_SCAN.value: "Phase 2 (YARA)",
    JobKind.GHIDRA_DECOMPILE.value: "Phase 2 (Ghidra headless)",
...
def _proposal(
    ...
    *,
    ...
    return ActionProposal(
        ...
        params=params or {},
        available=planned_note is None,
        unavailable_reason=f"Not implemented until {planned_note}" if planned_note else None,
    )
